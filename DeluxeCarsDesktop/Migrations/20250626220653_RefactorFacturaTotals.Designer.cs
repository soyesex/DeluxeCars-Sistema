...
namespace DeluxeCarsDesktop.Migrations
{
    ...
    [Migration("20250626220653_RefactorFacturaTotals")]
    partial class RefactorFacturaTotals
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DeluxeCarsDesktop.Models.DetalleNotaDeCredito", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DeluxeCarsDesktop.Models.NotaDeCredito", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DeluxeCarsDesktop.Models.PagoCliente", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DeluxeCarsDesktop.Models.PagoClienteFactura", b =>
                {
            ...
            modelBuilder.Entity("DeluxeCarsDesktop.Models.DetalleNotaDeCredito", b =>
                {
                    b.HasOne("DeluxeCarsDesktop.Models.NotaDeCredito", "NotaDeCredito")
                        .WithMany("Detalles")
            ...
            modelBuilder.Entity("DeluxeCarsDesktop.Models.NotaDeCredito", b =>
                {
                    ...
                    b.HasOne("DeluxeCarsDesktop.Models.Factura", "FacturaOriginal")
            ...
            modelBuilder.Entity("DeluxeCarsDesktop.Models.PagoClienteFactura", b =>
                {
                    ...
                    b.HasOne("DeluxeCarsDesktop.Models.PagoCliente", "PagoCliente")
